...
import { ArrowUpRight, Sparkles, Car, Shield, Images } from "lucide-react";
...
const services = [
  {
    ...
    gallery: [exteriorDetail, heroImage, greenPorsche, detailingProcess],
  },
  {
    id: "interior",
    ...
    gallery: [interiorDetail, detailingProcess, heroImage, greenPorsche],
  },
  {
    id: "ceramic",
    ...
    gallery: [ceramicCoating, greenPorsche, detailingProcess, exteriorDetail],
  },
];
...
const ServicesGrid = () => {
  ...
  const openGallery = (service: typeof services[0], e: React.MouseEvent) => {
    e.preventDefault();
    e.stopPropagation();
                ...
                <div className="relative h-56 overflow-hidden rounded-t-3xl">
                  ...
                  >
                    <motion.div
                      ...
                      whileTap={{ scale: 0.95 }}
                    >
                      <Images size={18} className="text-primary-foreground" />
                    </motion.div>
                  </MagneticButton>
                  ...
                  >
                    <MagneticButton strength={0.5}>
                      <motion.div
                        className="w-10 h-10 rounded-full bg-secondary border border-border flex items-center justify-center cursor-pointer"
